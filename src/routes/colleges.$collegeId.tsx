...
export const Route = createFileRoute("/colleges/$collegeId")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Programs, admission information, facilities and contact details for the college.",
      },
      { property: "og:title", content: "College details | College Finder Nepal" },
      {
        property: "og:description",
        content: "Programs, admission info, facilities and contacts for colleges in Nepal.",
      },
    ],
  }),
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      <div className="mt-4 flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-foreground sm:text-3xl">{college.name}</h1>
        ...
        >
          {isSaved(college.id) ? <BookmarkCheck className="size-4" /> : <Bookmark className="size-4" />}
